...
export default function Footer() {
  return (
    <Box h="182px" borderTop="1px solid gray" mt="20px" w="1191px" m="auto">
      <Container as={Stack} maxW={"6xl"} py={10}>
        ...
        >
          ...
          >
            ...
            <Text fontSize="14px" w="212px" h="34px" ml="10px">
              Copyright © 2023 Creative Proxes All rights reserved
            </Text>
            <Box mt="15px">
              <Button
                bgColor="lightblue"
          ...
          <Stack align={"flex-start"}>
            ...
            <Link href={"#"}>Proxy location checker</Link>
            <Link href={"#"}>IPv6 Comptability</Link>
            <Link href={"#"}>Blogs</Link>
          </Stack>
          <Stack align={"flex-start"} W="500px">
            <Text color="gray">Reaources</Text>
            <Link href={"#"}>FAQs</Link>
            <Link href={"#"}>Branding</Link>
            <Link href={"#"}>Network Information</Link>
